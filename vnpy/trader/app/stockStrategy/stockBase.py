...
'''
本文件中包含了Stock模块中用到的一些基础设置、类和常量等。
'''
...
# 本地停止单前缀
STOPORDERPREFIX = 'StockStopOrder.'
...
# CTA模块事件
EVENT_STOCK_LOG = 'eStockLog'               # STOCK相关的日志事件
EVENT_STOCK_STRATEGY = 'eStockStrategy.'    # STOCK策略状态变化事件
